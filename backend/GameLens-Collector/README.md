...
```bash
docker exec -i postgres_db psql -U your_username -d your_database_name < db/GameLens-Schema-Updated.sql && docker exec -i postgres_db psql -U your_username -d your_database_name < db/dashboard_schema.sql
```
