...
const PHASE_BUCKETS = [
  { id: 'early', label: 'Early Game', sublabel: '0 – 5 min', minSec: 0, maxSec: EARLY_END_SEC },
  { id: 'mid', label: 'Mid Game', sublabel: '5 – 15 min', minSec: EARLY_END_SEC, maxSec: MID_END_SEC },
  { id: 'late', label: 'Late Game', sublabel: '15+ min', minSec: MID_END_SEC, maxSec: Infinity },
];
