        ...
        <div className="flex items-center gap-3">
          ...
          {auth.loggedIn && auth.syncStatus === 'syncing' && (
            <div className="flex items-center gap-1.5 rounded-lg border border-cyan-500/20 bg-slate-900/60 px-3 py-1.5">
              <RefreshCw className="h-3 w-3 animate-spin text-cyan-400" aria-hidden />
          ...
          {auth.loggedIn ? (
            ...
            >
              ...
              <span className="font-data text-sm font-semibold tracking-wide">Sign in</span>
            </button>
          )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-sm">
          ...
          >
            ...
            <input
              ...
              className="w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 font-data text-sm text-slate-100 focus:border-cyan-500/60 focus:outline-none"
              placeholder="you@example.com"
            />
            {loginError && (
              <p className="mt-2 font-data text-xs text-red-400">{loginError}</p>
            )}
