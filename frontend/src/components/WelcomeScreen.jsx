    ...
    <div className="relative flex min-h-screen overflow-hidden bg-slate-950 text-slate-100">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-1 flex-col lg:flex-row lg:items-stretch">
        ...
        >
          ...
          <p className="font-display text-[10px] font-bold uppercase tracking-[0.4em] text-cyan-500/80">
          ...
          <p className="mt-5 max-w-md font-data text-sm leading-relaxed text-slate-400 md:text-base">
          ...
          <ul className="mt-10 space-y-4">
            {[
              ...
              <li key={title} className="flex gap-3">
                ...
                <div>
                  <p className="font-display text-[10px] font-bold uppercase tracking-[0.18em] text-slate-300">
                    {title}
                  </p>
                  <p className="font-data mt-0.5 text-xs text-slate-500">{text}</p>
                </div>
              </li>
            ))}
          </ul>
          ...
          <div className="w-full max-w-md rounded-2xl border border-cyan-500/20 bg-slate-900/55 p-8 shadow-[0_0_60px_rgba(34,211,238,0.08),inset_0_1px_0_rgba(255,255,255,0.04)] backdrop-blur-xl ring-1 ring-slate-800/80">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label
                  ...
                  className="font-display text-[9px] font-bold uppercase tracking-[0.2em] text-slate-500"
                >
                  Email address
                </label>
                <div className="relative mt-2">
                  ...
                  <input
                    ...
                    disabled={submitting}
                    className="font-data w-full rounded-xl border border-slate-700 bg-slate-950/80 py-3 pl-10 pr-4 text-sm text-slate-100 placeholder:text-slate-600 outline-none transition focus:border-cyan-500/50 focus:ring-2 focus:ring-cyan-500/20 disabled:opacity-60"
                  />
                </div>
                <p className="font-data mt-2.5 text-[11px] leading-relaxed text-slate-500">
              ...
              {error ? (
                <p
                  className="rounded-lg border border-red-500/30 bg-red-950/40 px-3 py-2 font-data text-xs text-red-300"
                  role="alert"
                >
                  {error}
                </p>
              ...
              <button
                type="submit"
                disabled={submitting}
                className="flex w-full items-center justify-center gap-2 rounded-xl border border-cyan-500/40 bg-linear-to-b from-cyan-600 to-cyan-800 py-3.5 font-display text-xs font-bold uppercase tracking-[0.16em] text-white shadow-[0_0_28px_rgba(34,211,238,0.25)] transition hover:shadow-[0_0_36px_rgba(34,211,238,0.35)] disabled:cursor-not-allowed disabled:opacity-50"
              >
                {submitting ? (
            ...
            <div className="relative my-7">
              ...
              <div className="relative flex justify-center">
                <span className="bg-slate-900/80 px-3 font-data text-[10px] uppercase tracking-widest text-slate-600">
                  or
                </span>
              </div>
            </div>
            ...
            <button
              ...
              disabled={submitting}
              className="flex w-full items-center justify-center gap-2 rounded-xl border border-slate-700 bg-transparent py-3 font-display text-[10px] font-bold uppercase tracking-[0.14em] text-slate-400 transition hover:border-slate-600 hover:bg-slate-800/40 hover:text-slate-200 disabled:opacity-50"
            >
              <UserRound className="h-4 w-4 shrink-0" strokeWidth={1.5} aria-hidden />
              Continue as Guest (Local Mode)
            </button>
            <p className="font-data mt-3 text-center text-[10px] text-slate-600">
